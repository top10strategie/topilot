...
function ComboboxContent({
  ...
  > & {
    /** Conteneur de portal (ex. tiroir) — défaut : body, ou conteneur du Drawer si présent. */
    container?: HTMLElement | React.RefObject<HTMLElement | null> | null
  }) {
  const drawerPortalContainer = useDrawerPortalContainer()
  const portalContainer = container ?? drawerPortalContainer ?? undefined
  ...
  return (
    <ComboboxPrimitive.Portal container={portalContainer}>
      <ComboboxPrimitive.Positioner
        ...
        anchor={anchor}
        className="pointer-events-auto isolate z-[300]"
      >
