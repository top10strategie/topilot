...
9. **Transverse avancé** — audit_log/historique, dashboards & analyses (CA, budget), gestion utilisateurs/catégories, page profil/préférences ; puis missions récurrentes et ré-authentification avant changement de mot de passe (règles à préciser à ce moment).
