...
9. **Transverse avancé** — audit_log/historique (`/history` + modales fiches), dashboards & analyses (CA, budget), page profil/préférences, missions récurrentes.
10. **Sécurité compte** — ré-authentification avant changement de mot de passe.
