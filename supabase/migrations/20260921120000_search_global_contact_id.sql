-- ============================================================================
-- TOPilot — search_global : entity_id du contact (plus l'id client)
-- Deux contacts du même client ne partagent plus la même clé.
-- parent_id = client_id pour contact_client, NULL sinon (navigation fiche client).
-- ============================================================================
