-- ============================================================================
-- TOPilot — Perf /documents : linked après pagination + versions distinctes
-- ============================================================================

CREATE OR REPLACE FUNCTION public.list_document_version_numbers()
...
AS $$
  SELECT DISTINCT d.version_number
  FROM public.document d
  WHERE d.version_number IS NOT NULL
  ORDER BY 1;
$$;

REVOKE ALL ON FUNCTION public.list_document_version_numbers() FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.list_document_version_numbers() TO authenticated;
      ...
      (
        ...
        FROM (
          ...
          FROM (
            ...
            WHERE col.profile_picture_id = p.id
            ...
            WHERE cc.profile_picture_id = p.id
          ) u
