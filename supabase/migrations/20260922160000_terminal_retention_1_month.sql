-- Rétention 1 mois des entités terminées sur list_missions_page /
-- list_opportunities_page (Kanban, Cartes, Tableau).
-- Réaffichage : p_include_archived (opp.) ou filtre statut explicite hors board.
